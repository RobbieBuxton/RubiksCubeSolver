 ...
 * @return                    Operation status code
 */
StatusCode sdt_translate(char **tokens, StringUintMap *symbols, uint current_offset, uint *output, AssemblyInfo *assemblyInfo);
 ...
 * @return                    Operation status code.
 */
StatusCode h_translate(char **tokens, StringUintMap *symbols, uint current_offset, uint *output, AssemblyInfo *assemblyInfo);

/**
 * The type of a function that translates an array of tokens into an instruction.
 */
typedef StatusCode (*TranslateFunction)(char **, StringUintMap *, uint, uint *, AssemblyInfo *);
