...
needed to be able to scramble and solve 3 $\times$ 3 Rubik's cube. To complete this project we split the team
...
a good idea although, on a few occasions, it did make it more difficult to keep track of 
who was doing what and make sure multiple people weren't working on the same thing.
This issue could have been prevented by making more extensive use of the Issues page
on GitHub.
...
Although, I do admit that we were a little too optimistic with our expectations for the extension, and I've learn that next time, we need to focus on getting working prototypes of our project before trying to refine it.
