...
\begin{minipage}{0.45\textwidth}
    ...
    \begin{tikzpicture}[node distance=2cm]
        ...
        \node (move_in_queue?) [scale=0.5, decision, align=center] at (3.5,-11.5) 
        {new state \\ visted hash \\ tree already?};
        \node (move_in_queue?) [scale=0.5, decision, align=center] at (3.5,-11.5) 
        {new state \\ visted hash \\ tree already?};
        ...
        \draw [arrow] (sub_queue_empty?) -- node[scale=0.5, yshift=0.3cm] {yes} (5,-8.5) -- (5,-1.5) -- (check_empty);
        \draw [arrow] (sub_queue_empty?) -- node[scale=0.5, xshift=0.5cm] {no} (take_move);
        \draw [arrow] (take_move) -- (move_in_queue?);
        \draw [arrow] (move_in_queue?) -- node[scale=0.5, yshift=0.3cm] {yes} (1.5,-11.5) -- (1.5,-8.5) -- (sub_queue_empty?);
